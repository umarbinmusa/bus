...
if (isset($_POST['buy'])) {
  ...
  if (!isset($_POST['seats']) || empty($_POST['seats'])) {
    ...
    if ($conn->query($sql)) {
      echo '<div class="alert alert-success">Purchase <strong>Success</strong>full!<a class="text-right" href="print.php?ticket='.$conn->insert_id.'"><button class="btn btn-info">Print</button></a> <a href="history.php"><button class="btn btn-primary">View History</button></a></div>';
    }
    else {
